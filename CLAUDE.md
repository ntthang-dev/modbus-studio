...
This project is indexed by GitNexus as **modbus-studio** (2088 symbols, 3687 relationships, 116 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
